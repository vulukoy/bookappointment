...
//$bookLink = "/book/" . htmlspecialchars($provider['booking_slug']?? $provider['username']);
//$_SERVER['REQUEST_SCHEME'] ?? 'http' . '://' . $_SERVER['HTTP_HOST'] . $bookLink;

$bookLink =($_SERVER['REQUEST_SCHEME'] ?? 'http') . '://' . $_SERVER['HTTP_HOST'] . "/book/" . htmlspecialchars($provider['booking_slug']?? $provider['username']);
